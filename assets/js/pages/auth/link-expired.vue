...
<template>
  <Head title="Verification expired | FieldNotes"></Head>
  <section
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <rect width="50" height="50" rx="25" fill="#FFECEC" />
        ...
        <h1 class="text-2xl font-bold tracking-tight">Token expired</h1>
    ...
    <footer class="my-8 text-center text-black">
      <Link href="/signup" class="flex items-center justify-center">
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
