  ...
  <section class="mx-auto max-w-2xl px-4">
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6">
      <div class="mb-6 flex items-center justify-between">
        <h1 class="text-xl font-semibold text-black">Edit Entry</h1>
        <span
          class="inline-flex rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium capitalize text-gray-600"
        >
          {{ entry.type }}
        </span>
      </div>
