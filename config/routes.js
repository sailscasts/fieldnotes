...
module.exports.routes = {
  ...
  // ── Entries (CRUD) ──────────────────────────────
  'GET    /entries': 'entry/view-entries',
  'GET    /entries/new': 'entry/view-create-entry',
  'GET    /entries/:id': 'entry/view-entry',
  'GET    /entries/:id/edit': 'entry/view-edit-entry',
  'POST   /entries': 'entry/create-entry',
  'PATCH  /entries/:id': 'entry/update-entry', // path param
  'DELETE /entries/:id': 'entry/delete-entry'
}
